...
def m_to_mmmm(m, lang='en'):
    l, key = [], 0
    if lang == 'en': key = 0
    if lang == 'nl': key = 1

    if    m in ['01','1', 1]: l = ['january','januari']
    elif  m in ['02','2', 2]: l = ['february','februari']
    elif  m in ['03','3', 3]: l = ['march','maart']
    elif  m in ['04','4', 4]: l = ['april','april']
    elif  m in ['05','5', 5]: l = ['mai','mei']
    elif  m in ['06','6', 6]: l = ['june','juni']
    elif  m in ['07','7', 7]: l = ['july','juli']
    elif  m in ['08','8', 8]: l = ['august','augustus']
    elif  m in ['09','9', 9]: l = ['september','september']
    elif  m in ['10', 10]:    l = ['october','october']
    elif  m in ['11', 11]:    l = ['nobemver','november']
    elif  m in ['12', 12]:    l = ['december','december']
